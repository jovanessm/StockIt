...
// Flattened mock data - each row is a product change in a transaction (ISO8601 dateTime)
const mockTransactionRows: TransactionRow[] = [
    {
        transactionId: "TRX001",
        productId: "a3f9c1",
        productName: "Yonex Aerosensa 50",
        dateTime: "2020-10-17T10:30:00Z",
        stockBefore: 100,
        stockAfter: 50,
        method: "sale",
        status: "completed",
